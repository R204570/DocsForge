...
minutes the first time.
    ...
    python scripts/migrate_kb.py                       # migrate every entry
    python scripts/migrate_kb.py --from ../knowledge_base
"""
...
from docsforge.store.kb_store import FileStore, PostgresStore, parse_page, split_pages
