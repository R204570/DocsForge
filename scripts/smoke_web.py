"""Live web smoke test — hits a running web chat (docsforge.server.app) and drives one real Groq turn.

Not collected by pytest (needs the server up, a GROQ_API_KEY, and the network).
Run:  python -m docsforge.server.app --port 8123
      python scripts/smoke_web.py [port] ["your prompt"]
"""
